/* ProMax extracted module: promax-ev */
(function(){
    ...
    var evGpsUnsub = null;
    function startEco() {
        if (evGpsUnsub || !window.PromaxGPSCore) return;
        evGpsUnsub = window.PromaxGPSCore.onFix(function (p) {
            if (!p || p.error || p.speed == null) return;
            var v = p.speed, t = p.timestamp;
