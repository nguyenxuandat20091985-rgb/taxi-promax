/**
 * api/admin-login.js — P0 secure (no hard-coded credentials)
 *
 * Bắt buộc set trên Vercel:
 *   ADMIN_PHONE
 *   ADMIN_PASSWORD_HASH   (sha256 hex của mật khẩu)
 *   ADMIN_SESSION_SECRET  (chuỗi ≥ 32 ký tự, khuyến nghị)
 *
 * Tạo hash: node scripts/hash-admin-password.mjs "matkhau"
 */
